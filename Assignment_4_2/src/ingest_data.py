...
output_file = os.path.join(ARTIFACTS_PATH, "strat_train_set.pkl").replace("\\", "/")
...
output_file = os.path.join(ARTIFACTS_PATH, "housing_labels.pkl").replace("\\", "/")
with open(output_file, "wb") as f:
...
output_file = os.path.join(ARTIFACTS_PATH, "housing_prepared.pkl").replace("\\", "/")
with open(output_file, "wb") as f:
...
output_file = os.path.join(ARTIFACTS_PATH, "y_test.pkl").replace("\\", "/")
with open(output_file, "wb") as f:
...
output_file = os.path.join(ARTIFACTS_PATH, "X_test_prepared.pkl").replace("\\", "/")
with open(output_file, "wb") as f:
